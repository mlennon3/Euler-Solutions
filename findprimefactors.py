...
#takes a list of numbers and divides its last numbers by its first numbers, eliminating any that are multiples of earlier numbers
...
multiple = input("Find greatest prime factor of what number?")
